...
Before running a downloaded executable, compare its SHA-256 checksum with the checksum published in the corresponding release notes.

Only download RVACoin Core releases from this repository or links published on the official RVACoin website.
